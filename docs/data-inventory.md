...
- 작성: 2026-09-19 · 재분류: 2026-09-22 (Task E, 데모 기준일 2025-12-30) · **갱신: 2026-09-24 (수급 실데이터)**
...
- **예시** — `frontend/lib/mock-data.ts`(예측 수치), `frontend/lib/providers/fixtures.ts`(기여도·재무), `frontend/lib/mock-performance.ts`. 화면에 "예시 데이터"로 표시된다.
