# 🟡 Yellow Block — 사용자 내부 정보

담당: 중현

## 역할

사용자의 투자 심리와 성향을 설문으로 수집하고, 다음 블록(green)이
...
/schema   노란색 블록이 출력하는 JSON 스키마
```

## 입출력

- 입력: 사용자 설문 응답 (객관식 5문항 + 자유 텍스트 1문항)
- 출력: `schema/yellow_output.schema.json` 형식의 JSON
...
green_cv / green_llm 은 이 JSON을 모델 입력 컨텍스트로 사용한다.
